...
class ParticleCanvas {
    ...
    #recordMousePosition() {
        ...
        document.addEventListener('mousemove', (e) => this.#updateMousePositionOnMouseMove(e));
    }
    ...
    #animate() {
        ...
        this.particles.forEach((particle, index) => particle.update(() => this.#replaceParticle(index)));
