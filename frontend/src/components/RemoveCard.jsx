...
const RemoveCard = ({ id, close, refresh }) => {
    ...
    return (
        <>
            ...
            <div className="fixed top-1/2 left-1/2 -translate-1/2 w-1/2 p-8 bg-gray-200 backdrop-blur-xl border border-gray-200 rounded-xl shadow-lg">
                <IoCloseOutline className='absolute right-5.5 top-5.5 text-3xl cursor-pointer text-gray-600 hover:text-black' onClick={() => close()}/>
                <h1 className="text-2xl font-bold text-gray-900 mb-5">Deletar card?</h1>
